...
export enum localizeStrEnum {
  ...
  POSITION_MIDDLE_LEFT = "POSITION_MIDDLE_LEFT",
  POSITION_MIDDLE_RIGHT = "POSITION_MIDDLE_RIGHT",
  ...
  FPS_TEXT_LABEL = "FPS_TEXT_LABEL",
  FPS_TEXT_DESCRIPTION = "FPS_TEXT_DESCRIPTION",
